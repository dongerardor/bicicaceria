myApp.controller('CheckInsController', function($scope, 
  ...
  $location, Authentication, Countgroups, FIREBASE_URL) {

  $scope.whichgroup = $routeParams.mId;
  ...
  var ref = new Firebase(FIREBASE_URL + "/users/" +
    $scope.whichuser + "/groups/" + 
    $scope.whichgroup + '/checkins');
  ...
  $scope.giveLove = function(myItem, myGift) {
    var refLove = new Firebase(FIREBASE_URL + '/users/'+
      $scope.whichuser + '/groups/' +
      $scope.whichgroup + '/checkins/' + myItem.$id +
      '/awards');
  ...
  $scope.deleteLove = function(checkinId, award) {
    var refLove = new Firebase(FIREBASE_URL + '/users/'+
      $scope.whichuser + '/groups/' +
      $scope.whichgroup + '/checkins/' + checkinId +
      '/awards');
